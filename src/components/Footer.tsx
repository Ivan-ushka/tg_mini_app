    ...
    return (
        <Container
            ...
            <div className={`d-flex flex-column p-3 ms-2 ${
                ...
                <p className="mt-1 p-0 mb-0 fs-1">Home</p>
            </div>
            <div className={`d-flex flex-column p-3 ${
                ...
                <p className="mt-1 p-0 mb-0 fs-1">Market</p>
            </div>

            <div className="rounded-circle" style={{marginTop: "-90px", backgroundColor: 'initial'}}>
            ...
            <div className={`d-flex flex-column p-3 ${
                ...
                <p className="mt-1 p-0 mb-0 fs-1">Alert</p>
            </div>
            <div className={`d-flex flex-column p-3 ${
                ...
                <p className="mt-1 p-0 mb-0 fs-1">Settings</p>
            </div>
        </Container>
    );
};
